...
module.exports = {
  ...
  async byId(req, res) {
    ...
    try {
      ...
      if (!category) 
        return res.status(httpStatus.BAD_REQUEST).json({ error: 'Erro ao tentar buscar categoria! Categoria n�o existente na base de dados.' });
  ...
  async delete(req, res) {
    ...
    try {
      ...
      if (category) {
        ...
        return res.status(httpStatus.BAD_REQUEST).json({ error: 'Erro ao tentar remover a categoria! Categoria n�o existente na base de dados.' });
      }
    } catch (error) {
