  ...
  async list(req, res) {
    ...
    try {
      ...
      return res.status(httpStatus.BAD_REQUEST).json({
        error: "Problema ao listar as receitas! Por favor, tente mais tarde."
      });
    }
  },
  ...
  async create(req, res) {
    ...
    try {
      if (done) {
        if (!dischargeDate)
          return res.status(httpStatus.BAD_REQUEST).json({
            error: "Data do recebimento é obrigatório!"
          });
      ...
      return res.status(httpStatus.BAD_REQUEST).json({
        error: "Problemas ao criar a receita! Por favor, tente mais tarde."
      });
    }
  },
  ...
  async update(req, res) {
    ...
    try {
      ...
      if (movement.done)
        return res
          .status(httpStatus.BAD_REQUEST)
          .json({ error: "Não é permitido editar recebimentos já realizados!" });
      ...
      return res.status(httpStatus.BAD_REQUEST).json({
        error: "Problemas ao atualizar o movimento! Por favor, tente mais tarde."
      });
    }
  },
  ...
  async delete(req, res) {
    ...
    try {
      ...
      if (movement.done) {
        return res
          .status(httpStatus.BAD_REQUEST)
          .json({ error: "Não é permitido deletar recebimentos já realizados!" });
      }
  ...
  async makeReceipt(req, res) {
    ...
    try {
      ...
      if (movement.value < value)
        return res.status(httpStatus.BAD_REQUEST).json({
          error: "O valor de recebimento deve ser menor ou igual ao valor do movimento!"
        });
